...
if __name__ == "__main__":
    ...
    uid_phone_mail = "61584913893791"

    password = "CDqhsOIBVlDGhLgs"

    twwwoo2fa = "G4G7Z6SNWUTLTTV72UNZD2FHJAEOVHT3".replace(" ", "")

    machine_id = "_2KxZzOokdiTAQGEsqoFdRJk" #Nếu báo sai mật khẩu thì lấy giá trị của cookies acc đó gán vào datr=_2KxZzOokdiTAQGEsqoFdRJk;
