        ...
        static void Main()
        {
            try
            {
               ...
               NativeBootstrap.Init();
                ...
                File.AppendAllText("dragon_startup.log", "Init OK, creating DB\n");
                Dragon.Database.AOTSqliteDb.EnsureCreated();

                var themeStyle = GetSettings.GetThemeStyle();
                var themeMode = GetSettings.GetThemeMode();
                ThemeHelper.SetTheme((ThemeMode)themeMode, (ThemeStyle)themeStyle);
                ...
                //FormMain //FormTestDGMode //FormTestScreenShotAndroid
                Application.Run(new FormMain());
            }
            catch (Exception ex)
            {
                File.WriteAllText("dragon_crash.log", ex.ToString());
                MessageBox.Show(ex.ToString(), "Dragon Crash");
            }
        }
