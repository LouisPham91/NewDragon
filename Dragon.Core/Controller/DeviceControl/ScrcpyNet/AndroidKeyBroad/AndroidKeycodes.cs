...
namespace Dragon.Controller.DeviceControl.ScrcpyNet.AndroidKeyBroad
{
    public enum AndroidKeycode : int
    {
        ...
        /** Refresh key.
         * Initiates a content refresh, e.g., in browsers or apps. */
        AKEYCODE_REFRESH = 285,
        /** Thumbs Up key.
         * Used in some interfaces for positive feedback (e.g., media or social apps). */
        AKEYCODE_THUMBS_UP = 286,
        /** Thumbs Down key.
         * Used in some interfaces for negative feedback (e.g., media or social apps). */
        AKEYCODE_THUMBS_DOWN = 287,
        /** Profile Switch key.
         * Switches between user profiles on supported devices. */
        AKEYCODE_PROFILE_SWITCH = 288,

        AKEYCODE_ASTERISK = 295,
        /** Stylus Tail Button key.
    * For stylus devices, the tail button. */
        AKEYCODE_STYLUS_BUTTON_TAIL = 296,
        /** Stylus Primary Button key.
         * For stylus devices, the primary button. */
        AKEYCODE_STYLUS_BUTTON_0 = 297,
        /** Stylus Secondary Button key.
         * For stylus devices, the secondary button. */
        AKEYCODE_STYLUS_BUTTON_1 = 298,
        /** Accessibility key.
         * Toggles accessibility features. */
        AKEYCODE_ACCESSIBILITY = 299,
    }
}
