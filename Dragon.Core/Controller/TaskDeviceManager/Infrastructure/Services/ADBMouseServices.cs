...
namespace Dragon.Controller.TaskDeviceManager.Infrastructure.Services
{
    public static class ADBMouseServices
    {
        ...
        //public static async Task<ExecutionStatus> Click(DLoopContext ctx, ClickArg click)
        //{
        //    var phone = ctx.Session.Phone;
        //    var adb = ctx.AdbClient;
        //    var dd = ctx.DeviceData;
        ...
        //        {
        //            var d = await Logger.DelayAsync(120, token, logKey);
        //            if (d == ExecutionStatus.Stop) return ExecutionStatus.Stop;
        //            await adb.ExecuteRemoteCommandAsync(cmd, dd, receiver, token);
        //        }
        ...
        //public static async Task<ExecutionStatus> Swipe(DLoopContext ctx, SwipeArg swipe)
        //{
        //    var phone = ctx.Session.Phone;
        //    var adb = ctx.AdbClient;
        //    var dd = ctx.DeviceData;
        ...
        //public static async Task<ExecutionStatus> LongPress(DLoopContext ctx, LongPressArg press)
        //{
        //    var phone = ctx.Session.Phone;
        //    var adb = ctx.AdbClient;
        //    var dd = ctx.DeviceData;
